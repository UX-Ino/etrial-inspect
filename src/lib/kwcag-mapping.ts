...
export const KWCAG_MAPPING: KWCAGItem[] = [
  // 1. 인식의 용이성 (9개 항목)
  {
    ...
    axeRules: ['image-alt', 'input-image-alt', 'object-alt', 'area-alt', 'svg-img-alt', 'kwcag-1-image-alt'],
  ...
  },
  {
    ...
    guideline: '자막 제공',
    checkItem: '자막 제공',
    axeRules: ['video-caption', 'kwcag-2-caption'],
  ...
  },
  {
    ...
    guideline: '콘텐츠의 선형화',
    checkItem: '콘텐츠의 선형화',
    axeRules: ['heading-order', 'list', 'definition-list', 'table-fake-caption', 'listitem', 'kwcag-4-linear-structure'],
    automationLevel: 'medium',
  ...
  },
  {
    ...
    guideline: '표의 구성',
    checkItem: '표의 구성',
    axeRules: ['table-caption', 'td-has-header', 'scope-attr-valid', 'th-has-data-cells', 'kwcag-3-table-structure'],
    automationLevel: 'high',
  ...
  },
  {
    ...
    guideline: '명도 대비',
    checkItem: '명도 대비',
    axeRules: ['color-contrast', 'color-contrast-enhanced', 'kwcag-8-color-contrast'],
    automationLevel: 'high',
  ...
  },
  {
    ...
    axeRules: ['link-in-text-block', 'kwcag-6-color-independent'],
    automationLevel: 'manual',
  ...
  },
  {
    ...
    guideline: '배경음 사용 금지',
    checkItem: '배경음 사용 금지',
    axeRules: ['no-autoplay-audio', 'kwcag-7-auto-play-stop'],
    automationLevel: 'medium',
  ...
  },
  {
    ...
    guideline: '콘텐츠 간의 구분',
    checkItem: '콘텐츠 간의 구분',
    axeRules: ['kwcag-9-content-separation'],
    automationLevel: 'manual',
  ...
  // 2. 운용의 용이성 (15개 항목)
  {
    ...
    guideline: '키보드 사용 보장',
    checkItem: '키보드 사용 보장',
    axeRules: ['accesskeys', 'tabindex', 'scrollable-region-focusable', 'kwcag-10-keyboard-access'],
    automationLevel: 'medium',
  ...
  },
  {
    ...
    guideline: '초점 이동과 표시',
    checkItem: '초점 이동과 표시',
    axeRules: ['focus-order-semantics', 'tabindex', 'kwcag-11-focus'],
    automationLevel: 'medium',
  ...
  },
  {
    ...
    guideline: '조작 가능',
    checkItem: '조작 가능',
    axeRules: ['button-name', 'link-name', 'aria-hidden-focus', 'nested-interactive', 'kwcag-12-touch-size'],
    automationLevel: 'high',
  ...
  },
  {
    ...
    guideline: '문자 단축키',
    checkItem: '문자 단축키',
    axeRules: ['kwcag-13-character-shortcut'],
    automationLevel: 'manual',
  ...
  },
  {
    ...
    guideline: '응답 시간 조절',
    checkItem: '응답 시간 조절',
    axeRules: ['meta-refresh', 'kwcag-14-response-time'],
    automationLevel: 'medium',
  ...
  },
  {
    ...
    guideline: '정지 기능 제공',
    checkItem: '정지 기능 제공',
    axeRules: ['blink', 'marquee', 'kwcag-15-auto-play-control'],
    automationLevel: 'high',
  ...
  },
  {
    ...
    axeRules: ['bypass', 'skip-link', 'region', 'kwcag-17-skip-nav'],
    automationLevel: 'high',
  ...
  },
  {
    ...
    guideline: '페이지 제목 제공',
    checkItem: '페이지 제목 제공',
    axeRules: ['document-title', 'page-has-heading-one', 'kwcag-18-page-title'],
    automationLevel: 'high',
  ...
  },
  {
    ...
    axeRules: ['link-name', 'link-in-text-block', 'identical-links-same-purpose', 'kwcag-19-link-text'],
    automationLevel: 'high',
  ...
  },
  {
    ...
    axeRules: ['kwcag-20-fixed-reference'],
    automationLevel: 'manual',
  ...
  },
  {
    ...
    axeRules: ['kwcag-21-single-pointer'],
    automationLevel: 'manual',
  ...
  },
  {
    ...
    guideline: '포인터 입력 취소',
    checkItem: '포인터 입력 취소',
    axeRules: ['kwcag-22-pointer-cancellation'],
    automationLevel: 'manual',
  ...
  },
  {
    ...
    guideline: '레이블과 네임',
    checkItem: '레이블과 네임',
    axeRules: ['label-content-name-mismatch', 'kwcag-23-label-name'],
    automationLevel: 'high',
  ...
  },
  {
    ...
    guideline: '동작기반 작동',
    checkItem: '동작기반 작동',
    axeRules: ['kwcag-24-motion-actuation'],
    automationLevel: 'manual',
  ...
  // 3. 이해의 용이성 (7개 항목)
  {
    ...
    guideline: '기본 언어 표시',
    checkItem: '기본 언어 표시',
    axeRules: ['html-has-lang', 'html-lang-valid', 'valid-lang', 'kwcag-25-doc-lang'],
    automationLevel: 'high',
  ...
  },
  {
    ...
    axeRules: ['presentation-role-conflict', 'kwcag-27-linear-structure'],
    automationLevel: 'medium',
    description: '콘텐츠는 논리적인 순서로 제공해야 한다.',
  ...
  },
  {
    ...
    guideline: '오류 정정',
    checkItem: '오류 정정',
    axeRules: ['aria-input-field-name', 'autocomplete-valid', 'kwcag-28-error-correction'],
    automationLevel: 'medium',
  ...
  },
  {
    ...
    guideline: '레이블 제공',
    checkItem: '레이블 제공',
    axeRules: ['label', 'select-name', 'form-field-multiple-labels', 'input-button-name', 'kwcag-29-label'],
    automationLevel: 'high',
  ...
  },
  {
    ...
    guideline: '접근 가능한 인증',
    checkItem: '접근 가능한 인증',
    axeRules: ['kwcag-30-accessible-auth'],
    automationLevel: 'manual',
  ...
  },
  {
    ...
    guideline: '반복 입력 정보',
    checkItem: '반복 입력 정보',
    axeRules: ['kwcag-31-redundant-entry'],
    automationLevel: 'manual',
  ...
  // 4. 견고성 (2개 항목)
  {
    ...
    guideline: '마크업 오류 방지',
    checkItem: '마크업 오류 방지',
    axeRules: ['duplicate-id', 'duplicate-id-active', 'duplicate-id-aria', 'kwcag-32-markup-validity'],
    automationLevel: 'high',
  ...
  },
  {
    ...
    axeRules: [
      ...
      // Custom Rules
      'kwcag-33-web-app-accessibility'
    ],
    automationLevel: 'high',
