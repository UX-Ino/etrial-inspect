...
.claude/            # Claude Code 전용 설정 (이 파일과 동일 레벨)
...
- 세부 규칙: `.claude/rules/` 참조.

## 현재 진행 중인 작업
`progress.md` 참조.

## 관련 에이전트 페르소나
- `.claude/agents/a11y-engineer.md` — 접근성 엔지니어
- `.claude/agents/code-reviewer.md` — 코드 리뷰어
